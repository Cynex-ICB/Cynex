    ...
    <article className="rounded-md border border-line bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="rounded-md border border-red-100 p-2 text-red-600 hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-300"
          type="button"
      ...
      <label className="mt-4 block text-sm font-semibold text-slate-700">
        ...
        <textarea
          ...
          className="mt-1 w-full rounded-md border border-line px-3 py-2 focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20 min-h-24"
        />
      </label>
